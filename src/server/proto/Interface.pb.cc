...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Interface_2eproto[3];
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Interface_2eproto = {
  &descriptor_table_Interface_2eproto_initialized, descriptor_table_protodef_Interface_2eproto, "Interface.proto", 217,
  &descriptor_table_Interface_2eproto_once, descriptor_table_Interface_2eproto_sccs, descriptor_table_Interface_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_Interface_2eproto::offsets,
  file_level_metadata_Interface_2eproto, 3, file_level_enum_descriptors_Interface_2eproto, file_level_service_descriptors_Interface_2eproto,
};
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Ye_Interface.ChatMsg.msg"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
